							...
							<div className="px-5 pb-3 nexa-font">
								...
								<div className="flex items-center justify-between ">
									<div className="flex flex-col items-start justify-start">
										{/* <span className="text-sm font-bold text-red-700 line-through dark:text-white">Rs:{course.price}</span> */}
										<span className="text-2xl font-bold text-gray-900 dark:text-white nexa-font">Rs:{course.price}.00</span>
									</div>
									<Link to={`/courses/${course._id}`}

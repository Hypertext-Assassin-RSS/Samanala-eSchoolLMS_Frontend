									...
									<div className="px-5 pb-5">
										...
										<div className="flex items-center justify-between">
											<div className="flex flex-col items-start justify-start">
												...
												<span className="text-2xl font-bold text-gray-900 dark:text-white">Rs:{course.price}.00</span>
											</div>
											<Link to={`/courses/enrolled/${course._id}`} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" style={{margin:20}}>Start Learning</Link>
										</div>
									</div>
								</div>
							))
